...
public class ManageOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Bill_DetailDAO bdd = new Bill_DetailDAO();
        
        bdd.updateBillDetail(Integer.parseInt(billdetailid), status);
        
        
        request.getRequestDispatcher("billAdmin").forward(request, response);
    }
