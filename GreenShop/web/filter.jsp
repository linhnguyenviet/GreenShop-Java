                ...
                <div class="product">  
                    ...
                    <div>
                        <form action ="HandleCartInPage" method="get">
                            ...
                            <input type="hidden" name="prev" value="Filter?index=<%=index%>">
                            <input type="hidden" name="filter" value="<%=filter%>">
                            <input type="hidden" name="index" value="<%=indexx%>">
            ...
            <ul class="pageBar">
                <%
                    ...
                    for (int i = 0; i <= length; i++) {
                        ...
                        if (count == indexx) {
                %>
                <li ><a class="active" href="Filter?index=<%=count%>&filter=<%=filter%>"> <%out.write(Integer.toString(count));%></a></li>
                    <% } else {
                    %>            
                <li><a href="Filter?index=<%=count%>&filter=<%=filter%>"> <%out.write(Integer.toString(count));%></a></li>
                    <% }
                    %>
                    <% }
                    %>
