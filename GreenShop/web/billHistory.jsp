                        ...
                        <tbody>
                            ...
                            <%                            CustomerDAO b = new CustomerDAO();
                                ...
                                for (int i = 0; i < bList.size(); i++) {
                                    ...
                                    if (bList.get(i).getStatus().equals("Chưa giao")) {
                                        out.print("<tr class=\"ProductRow\">");
                                        out.print("<td>");
                                        out.print(bList.get(i).getBillID());

                                        out.print("<input type=\"text\" value=\"");
                                        out.print(bList.get(i).getbDetailID());
                                        out.print("\" name=\"billDetailID\" style=\"display:none;\">");
                                        ...
                                        out.print("</td>");
                                        out.print("<td>");
                                        //       out.print("<input type=\"text\" placeholder=\"Input your old password\" name=\"newQuantity\">");
                                        out.print("<input type=\"text\" placeholder=\"");
                                        out.print(bList.get(i).getQuantity());
                                        out.print("\" name=\"newQuantity\">");
                                        out.print("</td>");
                                        ...
                                        out.print(bList.get(i).getStatus() + " <input type=\"submit\" name=\"action\" value=\"Delete\"> ");
                                        
                                        
                                        out.print("</td>");

                                        //out.print("Chua giao dich thanh cong<button type=\"submit\">Edit</button>");
                                    }
